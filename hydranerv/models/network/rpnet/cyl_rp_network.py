...
class CylRPNetwork(RPNetwork):
    ...
    def __init__(self, num=100, num_hyp=30, num_ped=30, gc=100, dt=.01, tmax=1000, t_ref=.1, conn_type='gap_junction',
                 t_syn=.01, rho=.5, lambda_d=.15, seed=0):
        """constructor"""
